...
class AnimatedToggle(QCheckBox):
    """继承子 QCheckBox 来实现一个 toggle switch button"""
    ...
    def hitButton(self, pos: QPoint):
        """
        设置可点击的区域。因为 QCheckbox 可点击的区域小，我们扩大它的点击范围
        :param pos:
        :return:
        """
        # 通过 contentsRect() 来扩展，让整个 toggle switch 按钮都可以被点击
    ...
    def paintEvent(self, e: QPaintEvent):
        ...
        p = QPainter(self)
        p.setRenderHint(QPainter.Antialiasing)  # 平滑边缘，消除锯齿
